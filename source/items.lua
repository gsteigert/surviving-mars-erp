...
PlaceObj('ModItemTechPreset', {
	...
	display_name = T(214691663241, --[[ModItemTechPreset ErpLightsOut display_name]] "Lights Out"),
	group = "Social",
...
PlaceObj('ModItemTechPreset', {
	...
	display_name = T(847837112378, --[[ModItemTechPreset ErpAIBreakthroughRevealer display_name]] "AI Breakthrough Revealer"),
	group = "Robotics",
...
PlaceObj('ModItemTechPreset', {
	...
	display_name = T(633059147018, --[[ModItemTechPreset ErpCompressedMatter display_name]] "Compressed Matter"),
	group = "Physics",
...
PlaceObj('ModItemTechPreset', {
	...
	display_name = T(578099905451, --[[ModItemTechPreset ErpEventDrivenArchitecture display_name]] "Event Driven Architecture"),
	group = "Robotics",
...
PlaceObj('ModItemTechPreset', {
	...
	display_name = T(887490482207, --[[ModItemTechPreset ErpExtendedSponsorResearch display_name]] "Extended Sponsor Research"),
	group = "Social",
...
PlaceObj('ModItemTechPreset', {
	...
	display_name = T(631714357426, --[[ModItemTechPreset ErpOutsourceDiscount display_name]] "Outsource Discount"),
	group = "Social",
...
PlaceObj('ModItemTechPreset', {
	...
	display_name = T(665228128967, --[[ModItemTechPreset ErpResupplyAlternatives display_name]] "Resupply Alternatives"),
	group = "Physics",
...
PlaceObj('ModItemTechPreset', {
	...
	display_name = T(633059147018, --[[ModItemTechPreset ErpTechFieldBooster display_name]] "Tech Field Booster"),
	group = "Biotech",
